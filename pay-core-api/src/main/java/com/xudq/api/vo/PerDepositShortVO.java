...
import com.xudq.api.enums.PayServiceType;

import javax.validation.constraints.NotNull;
import javax.validation.constraints.Pattern;

public class PerDepositShortVO {
    private String id;
    ...
    调账类型：
            ...
            5.资金划拨
    */
    private String adjustmentType="2";

    private String adjustmentStatus="0";

    @Pattern(regexp = "^[1,2]$",message = "调账方式不合法")
    private String adjustmentMode;

    private String payServiceType = PayServiceType.PERDEPOSITSHORT.getId();
